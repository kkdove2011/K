...
function historySummary(single) {
    ...
    list.forEach((item, index) => {
        if (item.length > 0) {
            ...
            if (index == 0) {
                currentPrice = price
                lowest30 = { Name: "30   > ", Price: `¥${String(price)}`, Date: date, Difference: difference(currentPrice, price), price }
                lowest90 = { Name: "90   > ", Price: `¥${String(price)}`, Date: date, Difference: difference(currentPrice, price), price }
                lowest180 = { Name: "180  > ", Price: `¥${String(price)}`, Date: date, Difference: difference(currentPrice, price), price }
                lowest360 = { Name: "360  > ", Price: `¥${String(price)}`, Date: date, Difference: difference(currentPrice, price), price }
            }
